                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('mahasiswa.update', $mahasiswa->id) }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="nim" name="nim" type="text" class="mt-1 block w-full" :value="old('nim', $mahasiswa->nim)" required />
                            <x-input-error class="mt-2" :messages="$errors->get('nim')" />
                        </div>

                        <div>
                            <x-input-label for="nama" :value="__('Nama Mahasiswa')" />
                            <x-text-input id="nama" name="nama" type="text" class="mt-1 block w-full" :value="old('nama', $mahasiswa->nama)" required />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_lahir" name="tanggal_lahir" type="date" class="mt-1 block w-full" :value="old('tanggal_lahir', $mahasiswa->tanggal_lahir)" required />
                        ...
                        <div>
                            ...
                            <textarea id="alamat" name="alamat" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" rows="3" required>{{ old('alamat', $mahasiswa->alamat) }}</textarea>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="no_hp" name="no_hp" type="text" class="mt-1 block w-full" :value="old('no_hp', $mahasiswa->no_hp)" required />
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('mahasiswa.index') }}" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md mr-4">
                                Batal
                            </a>
                            <x-primary-button>
                                {{ __('Perbarui Data') }}
